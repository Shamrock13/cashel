...
### Syslog
Enable in Settings → Syslog. All application events (audit results, SSH attempts, scheduler runs) are forwarded to the configured server at INFO level with the prefix `cashel LEVEL logger message`.
...
Cashel is free and open source. If it's saved you time or caught something in your configs, consider buying me a coffee — it goes directly toward keeping this maintained and adding new features.
